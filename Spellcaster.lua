...
-- Constraints: -----------------------|
local ver = "2.0.2c"
local cordCode = "https://discord.gg/vdqfcVjeYk"
---------------------------------------|
...
local IsExe = identifyexecutor and identifyexecutor() == "SpellCaster.exe"
...
function Stand(Text1,Text2,Text3,Text4,Text5,Text6,Btn)
	...
	LoadingFrame.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
	...
	RandomReason.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
	...
	RunQuestion.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
	...
	Executors.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
	...
	Paid.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
	...
	Help.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
	...
	HmmButton.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
	HmmButton.BackgroundTransparency = 0.700
	HmmButton.BorderColor3 = Color3.fromRGB(1, 1, 1)
...
if isfile then
	if not isfile("SPELLCASTER.lua") then
...
local Donors = {
	...
	["POTIONSTEALAH"] = "Custom1",
	["z8nos"] = "Custom2",
	["NitoOV"] = "Custom3",
	["mewguns"] = "Custom4",
	["SSSSLLUUUUMMM"] = "Custom5",
	["slaywurldsuuljah"] = "Custom6",
	["v9mpies"] = "Custom7",
	["s8reen"] = "Custom8",
}
...
function updatesaves()
	local update = {
		...
		CMDTab = CMDTab;
		TabsOff = TabsOff;
		KeepSpellCasterOn = KeepSpellCasterOn;
		ifKickedAuto = ifKickedAuto;
		whyIs = whyIs;
		drawingtype = drawingtype;
	}
	writefile("SPELLCASTER.lua", game:GetService("HttpService"):JSONEncode(update))
end

function loadsaves()
    local success, errorsend = pcall(function()
        saves = game:GetService("HttpService"):JSONDecode(readfile("SPELLCASTER.lua"))
    end)
    if not success then
        loaddefaults()
        updatesaves()
    ...
    KeepSpellCasterOn = saves.KeepSpellCasterOn
...
if AntiCheat.HideParentInExploit then
	...
	elseif get_hidden_gui then
		...
		Stand("Your exploit does not support syn.protect_gui/get_hidden_gui!","spellcaster cannot run.","Explanation;","This game has an anti-cheat and our way of stopping it is through syn.protect_gui/get_hidden_gui.","","Run Anyway?",true)
		repeat wait() until RunDude == true
	end
end
...
if AntiCheat.RemoveScripts then
	...
	Stand("spellcaster has to delete local scripts!","Your game may not work.","Explanation;","This game has an anticheat and our way of solving it is removing scripts.","","Run Anyway?",true)
	repeat wait() until RunDude == true
end
...
cmd.PlaceholderText = "Cast a spell here"
cmd.Text = ""
...
-- yes this is a skidded version of cmd x (but its better LAWL)
...
local Hints = {"Did you know you can execute multiple commands with ';;'?","Did you know you can create a wait using timedcmd in loops?","You can find commands using 'cmds'.","You can change your prefix by doing 'prefixnew (key)'","Did you know spellcaster was created in October 2021?"}
...
opxviewertitle.Text = "SPELLCASTER OUTPUT-LONGER"
...
statviewertitle.Text = "SPELLCASTER STATISTICS VIEWER"
...
logsviewertitle.Text = "SPELLCASTER LOGS VIEWER"
...
local CMDS = {}
CMDS.commands = {
	["prefix"] = "Shows you the cmd prefix.",
	["promptnew"] = "Changes your prompt text to something else.",
	["prefixnew"] = "Changes cmd prefix.",
	...
	["entercmdnew"] = "Adds a new command which runs when you first execute spellcaster.",
	...
	["support"] = "If you need support while using spellcaster use this command!",
	["commands"] = "Shows this page.",
	["advertise"] = "Help spread spellcaster by doing this cmd in game! (<3)",
	["unadvertise"] = "()",
	...
	["credits"] = "Lists credits for spellcaster.",
	...
	["streamermode"] = "Hides all names in games (Suitable for streamers or people showcasing spellcaster <3).",
	...
	["changestyle"] = "Changes the style of your spellcaster refer to csinfo for more info on this command.",
	...
	["using"] = "Specifies that you are using spellcaster. <3",
	...
	["runafter"] = "Makes spellcaster automatically re-execute on rejoin.",
	...
	["unbackpackplay"] = "()",
	["migratesaves"] = "Migrates save files/backups to spellcaster.lua.",
	...
	["rejoinexecute"] = "Rejoins and re-executes spellcaster once.",
	...
	["nilchatcmds"] = "Makes spellcaster chat commands not appear on chat.",
	["unnilchatcmds"] = "()",
	...
	["unretardchat"] = "()",
	["scriptusers"] = "Shows people currently using spellcaster.",
	...
	["yesmessages"] = "()",
	["removecmd"] = "Removes command from spellcaster temporarily.",
...
if KeepSpellCasterOn and syn.queue_on_teleport then
	syn.queue_on_teleport('loadstring(game:HttpGet("https://raw.githubusercontent.com/murderjj/spellcaster/main/spellcaster"))()')
end
...
fileworkspace.BackgroundColor3 = Color3.fromRGB(159, 56, 149)
...
fileext.Text = "plugins go inside spellcaster Plugins folder located in workspace"
...
function Template2(name,entry)
	...
	TemplateBtnRemove.BackgroundColor3 = Color3.fromRGB(159, 56, 149)
	...
	TemplateBtnAdd.BackgroundColor3 = Color3.fromRGB(159, 56, 149)
...
ManageTitleEnter.Text = "SPELLCASTER EnterCMDs MANAGER"
...
SlideOutEnter.BackgroundColor3 = Color3.fromRGB(159, 56, 149)
...
function useCommand.advertise()
	...
	while cmdAdvertise do
		local str = "get spellcaster today! best admin GUI, supports paid executors: cxrd: .gg/vdqfcVjeYk or type in spellcaster admin on google!"
	...
	opx("-","Now advertising spellcaster (Thank you!)")
end

function useCommand.unadvertise()
	cmdAdvertise = false
	opx("-","Stopped advertising spellcaster (Thank you!)")
end

function useCommand.version()
	opx("-","spellcaster is currently on "..ver)
end
...
function useCommand.using()
	opx("-","Said script <3")
	sayremote:FireServer("I am using spellcaster, Version: "..ver, "All")
end
...
function useCommand.resetsaves()
	...
	if Confirmation then
		opx("-","Successfully reset spellcaster.")
	...
	if Confirmation then
		if arguments[2] then
			...
			if isfile("CMD-X.save") then
				...
				opx("*","You do not have a spellcaster save.")
			end
		end
	end
end
...
function useCommand.reload()
	opx("-","Reloading spellcaster...")
	loadstring(game:HttpGet("https://raw.githubusercontent.com/murderjj/spellcaster/main/spellcaster", true))()
end
...
function useCommand.messagebox()
	if messageboxasync then
		...
		messageboxasync(getstring(2), "spellcaster Message", 262148)
	else
...
function useCommand.runafter()
	if arguments[2] == "on" then
		opx("-","spellcaster will now run after rejoin")
		KeepSpellCasterOn = true
		if KeepSpellCasterOn and syn.queue_on_teleport then
			syn.queue_on_teleport('loadstring(game:HttpGet("https://raw.githubusercontent.com/murderjj/spellcaster/main/spellcaster"))()')
		end
		updatesaves()
	elseif arguments[2] == "off" then
		opx("-","spellcaster will no longer run after rejoin")
		KeepSpellCasterOn = false
		updatesaves()
	else
		opx("*","2 arguments are required!")
...
ManageTitleHotkey.Text = "SPELLCASTER Hotkey MANAGER"
...
SlideOutHotkey.BackgroundColor3 = Color3.fromRGB(159, 56, 149)
...
function useCommand.scriptusers()
	if sDetect then
		...
		opx("-","Now showing users using spellcaster")
...
function useCommand.playercases()
	...
	using - Chooses a player that is using spellcaster")
end
...
function useCommand.credits()
	...
	Owner - "..DevCords[1].."\
	Dev - "..DevCords[2].."\
	Former Founder - xxpellcaster\
	Thank you to IY for some functions inside spellcaster\
	Thank you to vee#0007 for animpack\
	Thank you also to vee#0007 for old-aimbot")
end
...
function useCommand.logchat()
	...
	if arguments[2] then
		...
		msg = string.rep("spellcaster Gang", 100)
	end
...
if not AntiCheat.PrintingOff then
	...
	StarterGui:SetCore("ChatMakeSystemMessage", {
		Text = "Welcome to spellcaster, "..cmdlp.Name..".";
...
for _,v in pairs(cmdp:GetPlayers()) do
	if Devs[v.Name] then
		opx("-",v.Name.." is in your server ("..Devs[v.Name].." of spellcaster)")
		RGBDev(v)
